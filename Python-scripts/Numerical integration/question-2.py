...
print(f'The integral value using Quad: {res}')
...
for n in N:
    ...
    print(f'Difference between Quad and Trapezoidal rule: {abs(res - T_R)}')

    S_1_3 = composite_simpson_one_third_rule(x, y)
    print(f'For n = {n}, Simpson\'s 1/3rd rule: {S_1_3}')
    print(
        f'Difference between Quad and Simpson\'s 1/3rd rule: {abs(res - S_1_3)}')
