...
muller_a(complex(-1, 0.9),
         complex(-1.4772872167775053, 0.7190733089686845),
         complex(-1.4732594924196465, 0.8074951700914978))

muller_b(complex(-1, 0.9),
         complex(-1.4772872167775053, 0.7190733089686845),
         complex(-1.4732594924196465, 0.8074951700914978))

muller_c(complex(-1.4732594924196465, 0.8074951700914978))
